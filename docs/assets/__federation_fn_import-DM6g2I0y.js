...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-x28ksfzk.js', import.meta.url).href),import:true},'vuex':{get:()=>()=>__federation_import(new URL('__federation_shared_vuex-CORSZprf.js', import.meta.url).href),import:true},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-yCBgeUIz.js', import.meta.url).href),import:true}};
